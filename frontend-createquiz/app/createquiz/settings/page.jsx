...
export default function SettingsForm() {
  ...
  const fetchFormData = async () => {
    ...
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_BASE_URL}/form/${form_id}`);
  ...
  const updateForm = (key, value) => {
    ...
    axios
      .patch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/form/${form_id}`, { [key]: updateValue })
