...
export default function QuizHeader({ quizData, selectedSection, onSectionSelect }) {
  ...
  return (
    <div className="bg-white border-b border-black">
      <header className="flex items-center justify-between p-4 relative">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div
            ...
            style={{
              backgroundColor: userData.profileImage
                ? "transparent"
                : "#D1D5DB", // Gray background if no image
            }}
          >
      ...
      <nav className="flex justify-center space-x-8 mt-4">
        {["คำถาม", "การตอบกลับ", "ตั้งค่า"].map((tab) => (
          <div key={tab} onClick={() => onSectionSelect(tab)}>
            <p
      ...
      {/* Theme Component */}
      {isThemeVisible && <Theme quizData={quizData} />}
